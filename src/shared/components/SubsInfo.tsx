  ...
  return (
    <div className="my-4 flex items-center gap-4">
      <Link
        to={`/followers/${userId}`}
        className={cn(
          "flex flex-1 flex-col items-center rounded-xl bg-sky-950/50 p-2 transition-colors hover:bg-sky-950/75",
          followers === 0 && "pointer-events-none"
        )}
      >
      ...
      <Link
        ...
        className={cn(
          "flex flex-1 flex-col items-center rounded-xl bg-sky-950/50 p-2 transition-colors hover:bg-sky-950/75",
          followings === 0 && "pointer-events-none"
        )}
      >
