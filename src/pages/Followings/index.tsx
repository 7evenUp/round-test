...
import { selectFollowingUsersPageByUserId } from "@/redux/slices/subscriptions"
...
const Followings = () => {
  ...
  const { users, hasNextPage } = useAppSelector((state) =>
    selectFollowingUsersPageByUserId(state, userId, 1, page * PAGE_SIZE)
  )
